...
image-vpc-nat-gateway-ubuntu:
	docker buildx build --platform linux/amd64 -t $(REGISTRY)/vpc-nat-gateway:$(RELEASE_TAG) -o type=docker -f dist/images/vpcnatgateway/Dockerfile.ubuntu dist/images/vpcnatgateway

.PHONY: image-vpc-nat-gateway-ubuntu-arm
image-vpc-nat-gateway-ubuntu-arm:
	docker buildx build --platform linux/arm64 -t $(REGISTRY)/vpc-nat-gateway:$(RELEASE_TAG) -o type=docker -f dist/images/vpcnatgateway/Dockerfile.ubuntu dist/images/vpcnatgateway
